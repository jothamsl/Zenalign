      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="flex flex-col lg:flex-row gap-6">
            ...
            >
              <div className="flex items-start justify-between">
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    ...
                    {criticalIssues > 0 && (
                      <>
                        {" "}
                        There are{" "}
                        <strong>{criticalIssues} critical issues</strong> that
                    ...
                    {warningIssues > 0 && (
                      <>
                        ...
                        <strong>
                          {warningIssues} additional warnings
                        </strong>{" "}
                ...
                <div className="flex flex-col items-center">
                  <div
                    className={`text-6xl ${getScoreColor(overallScore / 100)}`}
                  >
                    {overallScore}
                  </div>
              ...
              <Card className="mb-4 rounded-2xl shadow-sm bg-red-50 border-red-200">
                <div className="p-6">
                  ...
                  <p className="text-sm text-red-700 mb-3">
                    Found {report.pii_report.summary.columns_with_pii} columns
                    ...
                    <div className="px-6 pb-6 border-t border-gray-100">
                      <div className="pt-4 space-y-4">
                        {report.class_imbalance.columns.map((col) => {
                          const ratio =
                            report.class_imbalance?.imbalance_ratios?.[col] ||
                            0;
                          const distribution =
          ...
          <ResourcesSidebar
            ...
            initialResources={report.domain_resources}
            resourcesStatus={report.resources_status}
          />
        </div>
      </div>
    </div>
